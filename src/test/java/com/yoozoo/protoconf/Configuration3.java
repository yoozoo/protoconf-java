...
public class Configuration3 implements ConfigurationInterface, WatchKeyInterface {
    ...
    private	static final Configuration3 _instance;
    private static final String[] _keys;
    static {
        _instance = new Configuration3();
        _keys = new String[] { "mysqlDsn","password","username" };
    }
    public static Configuration3 instance() { return _instance;}
    public String applicationName() { return "北美平台-测试java"; }
